...
public class ProcessTransactions {
  public static void main(String[] args) {
    ...
    while (keepGoing.equals("y") || keepGoing.equals("y")) {
      ...
      System.out.print("\nEnter the number of the account you would liketo access: ");
      ...
      System.out.println(String.format("DepositTimes: %d", Account.getDepositTimes()));
      // Print number of withdrawals
      System.out.println(String.format("WithdrawTimes: %d", Account.getWithdrawTimes()));
      // Print total amount of deposits
      System.out.println(String.format("DepositAmount: %.2f", Account.getDepositAmount()));
      // Print total amount of withdrawals
      System.out.println(String.format("WithdrawAmount: %.2f", Account.getWithdrawAmount()));
      // claer statics
      Account.clearPerDayStatics();
